...
public class AllTheTrivia {
    ...
    public static void main(String[] args) {
        ...
        questions[0] = "What singer was known for her hit 'Baby One More Time' ?"; // Britney Spears
        questions[1] = "Which American president was the only one to be impeached twice?"; // Donald Trump
        questions[2] = "Who invented the test that measures whether computer conversation is distinguishable from a person?"; // Alan Turing
        questions[3] = "Which celebrity was known on Netflix for his show about big cats?"; // Tiger King
